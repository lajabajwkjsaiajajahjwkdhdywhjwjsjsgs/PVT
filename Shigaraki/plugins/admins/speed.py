...
from Shigaraki.utils import AdminRightsCheck
from Shigaraki.utils.database import is_active_chat, is_nonadmin_chat
from Shigaraki.utils.decorators.language import languageCB
from Shigaraki.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await Shigaraki.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
